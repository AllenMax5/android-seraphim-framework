...
- **Platform Components**: Use built-in (`View`, `Text`, `TouchableOpacity`). Avoid DOM (`div`,
  `span`).
...
See [references/patterns.md](references/patterns.md) for Container/Presentational split, HOCs,
Render Props, Compound Components, and Slot patterns.
