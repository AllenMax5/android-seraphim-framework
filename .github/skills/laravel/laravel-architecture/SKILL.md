...
See [project structure](references/implementation.md#project-structure) for the recommended
directory layout.
...
See [implementation examples](references/implementation.md#controller-pattern) for slim controller,
action class, and service container binding patterns.
