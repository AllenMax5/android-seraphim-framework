...
- Always use `ComponentHarness` (e.g., `MatButtonHarness`) instead of CSS selectors — harnesses are
...
- Angular v20+ supports **Vitest** natively via `@angular/build:unit-test`. Faster, native ESM, no
  Karma needed.
