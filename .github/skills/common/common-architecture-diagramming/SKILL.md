...
- **Select Type**: Sequence (Protocol), ERD (Data), State (Lifecycle), Cloud (Infra).
  See [Selection](references/diagram-selection.md).
...
- **Governance**: CRITICAL: Review [best-practices.md](references/best-practices.md) before
  starting.
