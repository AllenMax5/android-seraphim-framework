...
To visualize the virtualized infrastructure and resources provided by cloud providers (AWS, GCP,
Azure).
...
Use `C4Deployment` or standard `graph TD` with specific provider icons if available, or clear
labeling.
