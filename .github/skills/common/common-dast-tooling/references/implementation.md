...
The following commands are standard for dynamic application security testing. Use these after
reconnaissance to find vulnerabilities in a running application (local or staging).
