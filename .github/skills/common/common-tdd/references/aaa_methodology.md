...
- **Rule**: Minimize shared state. Use `beforeEach` only for common environment hooks, not data
  setup.
...
- **Rule**: Avoid multiple actions. If you're testing a "get-after-set" flow, that's an Integration
