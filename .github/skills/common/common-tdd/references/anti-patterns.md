...
**Good**: changing the design to be more testable (e.g., Dependency Injection) or testing the public
API.

## 3. Mocking Without Understanding

**Bad**: Mocking a library or dependency without knowing how it actually behaves, leading to "
success" in tests but failure in production.
...
**Good**: If a mock is that complex, you probably need a real object or a fake (lightweight
implementation).
