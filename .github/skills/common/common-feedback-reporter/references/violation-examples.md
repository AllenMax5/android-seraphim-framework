...
Comprehensive examples of how to recognize and report skill violations, including the three
diagnostic fields added to every report.
...
> ℹ️ The original Issue #67 report was missing `Root Cause`, `User Intent`, and `Skill Gap`. These
> three fields are what make a report actionable for skill authors.
