...
This reference maps the [Tessl Evaluation Scale](https://docs.tessl.io/evaluate/evaluating-skills)
to our internal `agent-skills-standard`.
...
- **GOOD**: "Validates HTTP headers, checks status codes, and sanitizes request bodies." (Concrete
  actions)
...
- **Standard**: If two skills overlap (e.g., `nestjs-security` and `common-security`), differentiate
  them in the first 10 words of the description.
