...
- **Templates, not examples**: Workflows define _structure_, not pre-filled data. The agent
  generates data at runtime.
- **No example rows in tables**: Include headers + 1 skeleton row only. Never populate with fake
  data.
