...
Java 21 introduced Virtual Threads, which are lightweight threads managed by the JVM. You should use
them for I/O-bound tasks.
...
For coordinating multiple related tasks (e.g., fetching data from multiple APIs), use
`StructuredTaskScope`.
