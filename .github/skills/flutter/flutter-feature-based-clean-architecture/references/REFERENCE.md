...
- [**Standard Folder Structure**](folder-structure.md) - Deep dive into feature-level directory
  nesting.
...
- Never import from `lib/features/x/data/` or `lib/features/x/presentation/` from outside
  `feature/x`.
