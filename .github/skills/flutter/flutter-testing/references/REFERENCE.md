...
- [**Mocking Standards**](mocking_standards.md) - Shared mocks, bloc state stubbing, external
  service mocking.
- [**Robot Pattern**](robot-pattern.md) - UI abstraction, symmetric assertions.
- [**Integration Testing**](integration-testing.md) - Patrol, Robot Pattern enforcement, auth
  helpers, navigation patterns.
