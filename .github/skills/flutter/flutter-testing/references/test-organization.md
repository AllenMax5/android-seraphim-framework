...
The `_integration_test.dart` suffix has a **specific technical meaning**: the file uses Patrol, runs
on a real device/emulator, and may interact with native OS dialogs.
