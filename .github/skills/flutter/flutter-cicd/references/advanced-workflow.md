...
1. **Concurrency Group**: `cancel-in-progress: true` stops old runs when new code is pushed to the
   same PR, saving minutes.
2. **Parallel Jobs**: `quality` and `test` trigger at the same time. If formatting fails, you don't
