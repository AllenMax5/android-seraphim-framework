...
- [ ] **Data Types**: Are Dates stored as `Date` objects (not strings)? Numbers as proper Number
  types?
...
- [ ] **Injection**: Are inputs validated/sanitized? (Avoid constructing query objects from raw user
  JSON).
