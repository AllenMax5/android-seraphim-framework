...
See [implementation examples](references/example.md#strictmode--why-did-you-render-setup) for
StrictMode, why-did-you-render, and custom hook debug label setup.

## Implementation Guidelines

- **Analysis**: Use `source-map-explorer` or `webpack-bundle-analyzer` /
...
- **Build**: Configure Terser for production minification. Use `vite-plugin-pwa` for service
  workers.
