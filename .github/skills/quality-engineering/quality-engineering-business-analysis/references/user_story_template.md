...
- Translation / locale
  behavior → [EZRX-42955](https://zuelligpharma.atlassian.net/browse/EZRX-42955)

---

## Acceptance Criteria

> One `Given / When / Then` block per AC. One condition per block. Tag every AC with platform and
> toggle state.
