...
You cannot import a Server Component directly into a Client Component. Instead, pass the Server
Component as a `children` prop.
...
Prevent accidental bundling of server-side logic (e.g., database clients, API secrets) into
client-side JS.
