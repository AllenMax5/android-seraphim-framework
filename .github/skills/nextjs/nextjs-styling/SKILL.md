...
1. **Choose library** — Tailwind/shadcn (preferred), CSS Modules (scoped), or Ant Design (with
   client wrappers).
...
- **No runtime CSS-in-JS with RSC**: MUI/Chakra force `'use client'`; prefer Tailwind or CSS
  Modules.
