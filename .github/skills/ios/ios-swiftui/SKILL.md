...
- [ ] **Body Property**: Is the **body property computationally cheap**? (No complex logic or
  calculations).
...
- **No Logic in Body**: Move calculations to **ViewModel or computed vars**. Keep `body` for UI
  composition only.
- **No ObservedObject Init**: Do **NOT** init `@ObservedObject` inside the View settings — this
