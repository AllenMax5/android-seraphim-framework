...
- **Request Scope (`Scope.REQUEST`)**: Bubbles up to controllers. Use sparingly due to
  re-instantiation overhead.
- **Durable Providers**: Use `durable: true` in multi-tenant apps to keep performance high while
  isolating contexts.
