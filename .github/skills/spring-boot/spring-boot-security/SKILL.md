...
See [implementation examples](references/implementation.md) for SecurityFilterChain configuration
with Lambda DSL and JWT.

## Implement Authentication and Authorization

- **Authentication**: Validation of credentials (Who are you?). Use `AuthenticationManager` or
  `JwtDecoder`.
