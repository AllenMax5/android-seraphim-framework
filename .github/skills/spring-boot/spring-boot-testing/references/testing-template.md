...
This reference demonstrates the "Base Class" pattern for Integration Tests using Spring Boot 3.1+
and Testcontainers.

> [!TIP]
> Use this pattern to avoid spinning up new containers for every test class. Reusing containers
