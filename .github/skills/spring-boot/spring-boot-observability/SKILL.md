...
See [implementation examples](references/implementation.md) for application.yaml tracing
configuration and actuator exposure.
...
See [implementation examples](references/implementation.md) for structured logging with MDC context
