...
| **android-deployment**           | `build.gradle.kts`, `proguard-rules.pro`, `.aab`            | signingConfigs, proguard, minifyEnabled, isMinifyEnabled, isShrinkResources, releaseKeystore                                                      |
...
| android-resources                | `strings.xml`, `**/*Screen.kt`, `R.string`                  | stringResource, plurals                                                                                                                           |
...
> Load matched skills: `<SKILLS>/android/<skill>/SKILL.md`. Load ALL that match — the tier model
> already filters irrelevant ones.
