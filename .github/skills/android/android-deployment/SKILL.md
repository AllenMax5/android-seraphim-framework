...
- **Minification**: Always enable `isMinifyEnabled = true` and `isShrinkResources = true` for
  Release builds (R8).
...
- **Rules**: Keep rules minimal. Use annotations (`@Keep`) for reflection-heavy classes instead of
